...
// Package log is the standard logging package extended to support log levels.
// It support DEBUG, INFO, and ERROR levels.  As it simply extends the interface
// existing log imports can be seemlessly swapped out.
...
func (l *Logger) check(line []byte) bool {
